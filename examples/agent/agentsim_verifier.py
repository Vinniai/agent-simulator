"""Reference agent-simulator verifier — claim-completed-tasks → diff snapshots → pass/fail.
...
def main() -> None:
    ...
    p.add_argument("--reviews-root", default=os.path.expanduser("~/.agent-simulator/reviews"))
